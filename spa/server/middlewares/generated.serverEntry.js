...
/*!****************************!*\
  !*** ./app/apiCallURLs.js ***!
  \****************************/
/*! exports provided: API_ENPOINT_PREFIX, BASE_URL, API_URL, APICALLURL_GETFRONTPAGEPOSTS */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"API_ENPOINT_PREFIX\", function() { return API_ENPOINT_PREFIX; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"BASE_URL\", function() { return BASE_URL; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"API_URL\", function() { return API_URL; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"APICALLURL_GETFRONTPAGEPOSTS\", function() { return APICALLURL_GETFRONTPAGEPOSTS; });\n/* harmony import */ var utils_detection__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! utils/detection */ \"./app/utils/detection.js\");\n\n\nfunction trimURLPrefix(someURL) {\n  // remove the http:// or https:// and place simply a // prefix\n  // const result = someURL.replace(/(^\\w+:|^)\\/\\//, '');\n  // return '//' + result;\n  return someURL;\n} // we might have a different SERVER_API_URL than API_URL, for example in the case where the SERVER_API_URL is in a VPC that is only accessible to the server, but not the client.\n\n\nvar someServerApiURL =  true ? \"http://hyperbole.local\" : undefined;\nvar API_ENPOINT_PREFIX = 'wp-json/hyperbole/v1';\nvar BASE_URL = Object(utils_detection__WEBPACK_IMPORTED_MODULE_0__[\"isServer\"])() ? \"\".concat(someServerApiURL) : \"\".concat(\"//hyperbole.local\");\nvar API_URL = Object(utils_detection__WEBPACK_IMPORTED_MODULE_0__[\"isServer\"])() ? \"\".concat(someServerApiURL, \"/\").concat(API_ENPOINT_PREFIX) : \"\".concat(\"//hyperbole.local\", \"/\").concat(API_ENPOINT_PREFIX);\nvar APICALLURL_GETFRONTPAGEPOSTS = \"\".concat(API_URL, \"/getfrontpageposts\");\n\n//# sourceURL=webpack:///./app/apiCallURLs.js?");
...
/*!********************************************!*\
  !*** ./app/containers/HomePage/actions.js ***!
  \********************************************/
/*! exports provided: loadFrontPagePosts, loadFrontPagePostsSuccess, loadFrontPagePostsFailure */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"loadFrontPagePosts\", function() { return loadFrontPagePosts; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"loadFrontPagePostsSuccess\", function() { return loadFrontPagePostsSuccess; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"loadFrontPagePostsFailure\", function() { return loadFrontPagePostsFailure; });\n/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./constants */ \"./app/containers/HomePage/constants.js\");\n/*\n * Home Actions\n *\n * Actions change things in your application\n * Since this boilerplate uses a uni-directional data flow, specifically redux,\n * we have these actions which are the only way your application interacts with\n * your application state. This guarantees that your state is up to date and nobody\n * messes it up weirdly somewhere.\n *\n */\n\nfunction loadFrontPagePosts() {\n  return {\n    type: _constants__WEBPACK_IMPORTED_MODULE_0__[\"LOAD_INITIAL_FRONTPAGEPOSTS\"]\n  };\n}\nfunction loadFrontPagePostsSuccess(data) {\n  return {\n    type: _constants__WEBPACK_IMPORTED_MODULE_0__[\"LOAD_INITIAL_FRONTPAGEPOSTS_SUCCESS\"],\n    data: data\n  };\n}\nfunction loadFrontPagePostsFailure() {\n  return {\n    type: _constants__WEBPACK_IMPORTED_MODULE_0__[\"LOAD_INITIAL_FRONTPAGEPOSTS_FAILURE\"]\n  };\n}\n\n//# sourceURL=webpack:///./app/containers/HomePage/actions.js?");
...
/*!**********************************************!*\
  !*** ./app/containers/HomePage/constants.js ***!
  \**********************************************/
/*! exports provided: LOAD_INITIAL_FRONTPAGEPOSTS, LOAD_INITIAL_FRONTPAGEPOSTS_SUCCESS, LOAD_INITIAL_FRONTPAGEPOSTS_FAILURE */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"LOAD_INITIAL_FRONTPAGEPOSTS\", function() { return LOAD_INITIAL_FRONTPAGEPOSTS; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"LOAD_INITIAL_FRONTPAGEPOSTS_SUCCESS\", function() { return LOAD_INITIAL_FRONTPAGEPOSTS_SUCCESS; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"LOAD_INITIAL_FRONTPAGEPOSTS_FAILURE\", function() { return LOAD_INITIAL_FRONTPAGEPOSTS_FAILURE; });\n/*\n * HomeConstants\n * Each action has a corresponding type, which the reducer knows and picks up on.\n * To avoid weird typos between the reducer and the actions, we save them as\n * constants here. We prefix them with 'yourproject/YourComponent' so we avoid\n * reducers accidentally picking up actions they shouldn't.\n *\n * Follow this format:\n * export const YOUR_ACTION_CONSTANT = 'yourproject/YourContainer/YOUR_ACTION_CONSTANT';\n */\nvar LOAD_INITIAL_FRONTPAGEPOSTS = 'hyperbole/Home/LOAD_INITIALFRONTPAGEPOSTS';\nvar LOAD_INITIAL_FRONTPAGEPOSTS_SUCCESS = 'hyperbole/Home/LOAD_INITIAL_FRONTPAGEPOSTS_SUCCESS';\nvar LOAD_INITIAL_FRONTPAGEPOSTS_FAILURE = 'hyperbole/Home/LOAD_INITIAL_FRONTPAGEPOSTS_FAILURE';\n\n//# sourceURL=webpack:///./app/containers/HomePage/constants.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return homePageSaga; });\n/* harmony import */ var redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! redux-saga/effects */ \"redux-saga/effects\");\n/* harmony import */ var redux_saga_effects__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var apiCallURLs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! apiCallURLs */ \"./app/apiCallURLs.js\");\n/* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./selectors */ \"./app/containers/HomePage/selectors.js\");\n/* harmony import */ var _actions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./actions */ \"./app/containers/HomePage/actions.js\");\n/* harmony import */ var utils_detection__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! utils/detection */ \"./app/utils/detection.js\");\n/* harmony import */ var utils_request__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! utils/request */ \"./app/utils/request.js\");\nvar _marked =\n/*#__PURE__*/\nregeneratorRuntime.mark(firstLoadSaga),\n    _marked2 =\n/*#__PURE__*/\nregeneratorRuntime.mark(homePageSaga);\n\n/**\n * Gets the repositories of the user from Github\n */\n\n\n\n // import { LOAD_REPOS } from 'containers/App/constants';\n// import { reposLoaded, repoLoadingError } from 'containers/App/actions';\n\n\n // import { makeSelectUsername } from 'containers/HomePage/selectors';\n\n/**\n * Github repos request/response handler\n */\n// export function* getRepos() {\n//   // Select username from store\n//   const username = yield select(makeSelectUsername());\n//   const requestURL = `https://api.github.com/users/${username}/repos?type=all&sort=updated`;\n//\n//   try {\n//     // Call our request helper (see 'utils/request')\n//     const repos = yield call(request, requestURL);\n//     yield put(reposLoaded(repos, username));\n//   } catch (err) {\n//     yield put(repoLoadingError(err));\n//   }\n// }\n\n/**\n * Root saga manages watcher lifecycle\n */\n// export default function* githubData() {\n//   // Watches for LOAD_REPOS actions and calls getRepos when one comes in.\n//   // By using `takeLatest` only the result of the latest API call is applied.\n//   // It returns task descriptor (just like fork) so we can continue execution\n//   // It will be cancelled automatically on component unmount\n//   yield takeLatest(LOAD_REPOS, getRepos);\n// }\n\nfunction firstLoadSaga() {\n  var frontPagePosts, doWeHaveDataYet, areWeLoading, someHomeStartData;\n  return regeneratorRuntime.wrap(function firstLoadSaga$(_context) {\n    while (1) {\n      switch (_context.prev = _context.next) {\n        case 0:\n          // what is the request url ...\n          // this is an interesting and complex thing to resolve ... where / how to we call the api ? how is the api's endpoints going to be organized?\n          // do we simply pull the most recent posts? or do we make a special page that lets the site editor select articles? or a slideshow? in short, how do we know what we are doing here on the front page?\n          // initially, let's just keep it simple. Get the n latest posts.\n          // much of the gutenberg bells and whistles might not work, in dangerouslySetInnerHTML'd content; js that is supposed to be included in the head will not be, and the document.ready, came and went before the content got loaded.\n          // console.log(` about to call ${APICALLURL_GETFRONTPAGEPOSTS}`);\n          console.log(\"firstLoadSaga()\");\n          _context.next = 3;\n          return Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__[\"select\"])(Object(_selectors__WEBPACK_IMPORTED_MODULE_2__[\"makeSelectPostStack\"])());\n\n        case 3:\n          frontPagePosts = _context.sent;\n          doWeHaveDataYet = frontPagePosts !== false;\n          _context.next = 7;\n          return Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__[\"select\"])(Object(_selectors__WEBPACK_IMPORTED_MODULE_2__[\"makeSelectLoading\"])());\n\n        case 7:\n          areWeLoading = _context.sent;\n          console.log(\"frontPagePosts==\", frontPagePosts, \"doWeHaveDataYet==\", doWeHaveDataYet, \"areWeLoading==\", areWeLoading); // // so ... here is the problem ... we need to refresh the ad data.\n\n          if (!(!doWeHaveDataYet && !areWeLoading)) {\n            _context.next = 26;\n            break;\n          }\n\n          _context.next = 12;\n          return Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__[\"put\"])(Object(_actions__WEBPACK_IMPORTED_MODULE_3__[\"loadFrontPagePosts\"])());\n\n        case 12:\n          _context.prev = 12;\n          _context.next = 15;\n          return Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__[\"call\"])(utils_request__WEBPACK_IMPORTED_MODULE_5__[\"default\"], apiCallURLs__WEBPACK_IMPORTED_MODULE_1__[\"APICALLURL_GETFRONTPAGEPOSTS\"]);\n\n        case 15:\n          someHomeStartData = _context.sent;\n          _context.next = 18;\n          return Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__[\"put\"])(Object(_actions__WEBPACK_IMPORTED_MODULE_3__[\"loadFrontPagePostsSuccess\"])(someHomeStartData));\n\n        case 18:\n          _context.next = 24;\n          break;\n\n        case 20:\n          _context.prev = 20;\n          _context.t0 = _context[\"catch\"](12);\n          _context.next = 24;\n          return Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__[\"put\"])(Object(_actions__WEBPACK_IMPORTED_MODULE_3__[\"loadFrontPagePostsFailure\"])());\n\n        case 24:\n          _context.next = 27;\n          break;\n\n        case 26:\n          console.log(\"what are we doing here?\");\n\n        case 27:\n        case \"end\":\n          return _context.stop();\n      }\n    }\n  }, _marked, this, [[12, 20]]);\n}\n\nfunction homePageSaga() {\n  return regeneratorRuntime.wrap(function homePageSaga$(_context2) {\n    while (1) {\n      switch (_context2.prev = _context2.next) {\n        case 0:\n          // why not, instead of making each one of these sagas check to see if it is on the clinet ort server, simply check here, and only call them if/when we need to. as opposed to always calling them, and leaving it up toi them wether or not they participate, based on whether they are on the client or server.\n          console.log(\"homePageSaga()\");\n\n          if (!Object(utils_detection__WEBPACK_IMPORTED_MODULE_4__[\"isServer\"])()) {\n            _context2.next = 6;\n            break;\n          }\n\n          _context2.next = 4;\n          return firstLoadSaga();\n\n        case 4:\n          _context2.next = 8;\n          break;\n\n        case 6:\n          _context2.next = 8;\n          return firstLoadSaga();\n\n        case 8:\n        case \"end\":\n          return _context2.stop();\n      }\n    }\n  }, _marked2, this);\n}\n\n//# sourceURL=webpack:///./app/containers/HomePage/saga.js?");
...
=======
/*! exports provided: parseJSON, checkStatus, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
